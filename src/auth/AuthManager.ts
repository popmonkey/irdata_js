...
class LocalStorageTokenStore implements TokenStore {
    ...
    getAccessToken() { return localStorage.getItem(this.prefix + 'access_token'); }
    setAccessToken(token: string) { localStorage.setItem(this.prefix + 'access_token', token); }
    getRefreshToken() { return localStorage.getItem(this.prefix + 'refresh_token'); }
    setRefreshToken(token: string) { localStorage.setItem(this.prefix + 'refresh_token', token); }
    clear() {
